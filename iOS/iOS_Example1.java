...
public class iOS_Example1
{
	...
	public void test2() throws InterruptedException 
	{
		...
		List<WebElement> tab=driver.findElements(By.className("UIAButton"));
		System.out.println("Tab Name: "+tab.size());
		for(WebElement elem : tab)
		{
			System.out.println("Tab Name: "+elem.getText());
			iOS_Common.wait(100);
		}		
		//Clicking all the tabs
		//driver.findElement(By.xpath("//UIAButton[@name='Base UI']")).click();
		//iOS_Common.wait(700);		
	}
