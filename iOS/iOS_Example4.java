...
public class iOS_Example4
{
	...
	public void test2() throws InterruptedException 
	{
		...
		WebElement item=iOS_Common.getItem(driver,"Button");
		if(item.getAttribute("name").equalsIgnoreCase("Button"))
		{
			item.click();
		...
		{
			System.out.println("Button name: "+elem.getText());
			if(elem.getText().equalsIgnoreCase("Click Me"))
			{
				System.out.println("Clicking on the button "+elem.getText());
				elem.click();
				iOS_Common.wait(300);
				System.out.println("Clicking on the button "+elem.getText());
				elem.click();
