//No.8 - KitchenSink:Views>Scroll Views>Basic
import java.io.File;
...
public class iOS_Example8
{
	...
	public void test2() throws InterruptedException 
	{
		...
		if(driver.findElement(By.xpath(prop.getProperty("Tab_Header"))).getText().equals("Base UI"))
		{
			...
			item=iOS_Common.getItem(driver,"Scroll Views");
			if(item.getAttribute("name").equalsIgnoreCase("Scroll Views"))
			{
				item.click();
				iOS_Common.wait(500);
			}
			...
			if(!driver.findElement(By.xpath("//UIAScrollView[1]/UIAButton[1]")).isDisplayed())
			{
				iOS_Common.scroll(driver, "up");
				iOS_Common.wait(500);
				driver.findElement(By.xpath("//UIAScrollView[1]/UIAButton[1]")).click();
				iOS_Common.wait(500);
			}
		}
	}
