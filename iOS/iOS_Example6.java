...
public class iOS_Example6
{
	...
	public void test2() throws InterruptedException 
	{
		...
		if(driver.findElement(By.xpath(prop.getProperty("Tab_Header"))).getText().equals("Base UI"))
		{
			...
			List<WebElement> buttons=driver.findElements(By.xpath("//UIAApplication[1]/UIAWindow[1]/UIAButton"));
			int k=1;
			for (WebElement elem : buttons)
			{
				System.out.println("Button Found: "+elem.getText());
				elem.click();
				iOS_Common.wait(50);
				if(k<3)
				{
					System.out.println(driver.findElement(By.xpath("//UIAApplication[1]/UIAWindow[3]/UIAActionSheet[1]/UIAStaticText[1]")).getText());

					List<WebElement> opbutton=driver.findElements(By.xpath("//UIAApplication[1]/UIAWindow[3]/UIAActionSheet[1]/UIAButton"));
					System.out.println("Button count: "+opbutton.size());
					for (WebElement elem1 : opbutton)
					{
						System.out.println("Button Found: "+elem1.getText());
					}
					opbutton.get(2).click();
					iOS_Common.wait(200);
					System.out.println(driver.findElement(By.xpath("//UIAApplication[1]/UIAWindow[1]/UIAStaticText[1]")).getText());
					iOS_Common.wait(200);
				}
				else{iOS_Common.wait(200);}
				iOS_Common.wait(200);
				k++;
			}
		}
