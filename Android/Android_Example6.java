...
public class Android_Example6 
{
	...
	public void test1() throws InterruptedException 
	{
		...
		Android_Common.NavigateListItem(driver, "Table Views");
		Android_Common.NavigateListItem(driver, "Basic");
		List<WebElement> textviews=driver.findElements(By.className("android.widget.TextView"));
		for (WebElement elem : textviews)
		{
			if(!elem.getText().equalsIgnoreCase("Basic"))
			{
				System.out.println(elem.getText());
				elem.click();
				Android_Common.wait(500);
				WebElement scrollview=driver.findElement(By.className("android.widget.ScrollView"));
				WebElement text=scrollview.findElement(By.className("android.widget.TextView"));
