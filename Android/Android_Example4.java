...
public class Android_Example4 
{
	...
	public void test1() throws InterruptedException 
	{
		...
		Android_Common.NavigateListItem(driver,"Button");
		List<WebElement> button=driver.findElements(By.className("android.widget.Button"));
		System.out.println(button.size());
		for(WebElement btntext : button)
		{
			//System.out.println(btntext.getText());
			if(btntext.getText().equalsIgnoreCase("Click Me"))
			{
				System.out.println("Clicking on the button "+btntext.getText());
				btntext.click();
				Android_Common.wait(500);
				System.out.println("Clicking on the button "+btntext.getText());
				btntext.click();
